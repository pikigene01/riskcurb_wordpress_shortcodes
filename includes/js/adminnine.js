...
/* Toast message appends here at bosy tag */
 setTimeout(function(){
    //   $('body').append('<div class="alert alert-info toastupdates alert-dismissable"> <button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button> <strong>Updates</strong><p>Plugin by RiskCurb <a href="https://riskcurb.com">Click here!</a></p></div>');
